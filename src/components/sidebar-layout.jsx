...
export function SidebarLayout({ navbar, sidebar, children }) {
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      {/* Sidebar on desktop */}
      {isSignedIn && <div className="fixed inset-y-0 left-0 w-64 max-lg:hidden">{sidebar}</div>}
      ...
      {/* Content */}
      <main className={`flex flex-1 flex-col pb-2 lg:min-w-0 ${isSignedIn ? 'lg:pl-64' : ''} lg:pr-2 lg:pt-2`}>
